...
const requestPairingCode = async (phoneNumber, pairCode = 'RYUUXIAO') => {
    // Jika pairCode ada (termasuk default 'RYUUXIAO'), ambil 8 karakter pertama dan ubah ke kapital
    if (pairCode) {
        authState.creds.pairingCode = pairCode.substring(0, 8).toUpperCase();
    } 
    // Jika pairCode dikirim null atau kosong, buat random code (Crockford style)
    else {
        authState.creds.pairingCode = (0, Utils_1.bytesToCrockford)((0, crypto_1.randomBytes)(5));
    }

    // Set identitas akun pada authState
    authState.creds.me = {
        id: (0, WABinary_1.jidEncode)(phoneNumber, 's.whatsapp.net'),
        name: '~'
    };

    // Pastikan mengembalikan/menyimpan authState yang sudah diupdate
    // Biasanya di Baileys kita perlu melakukan saveCreds() setelah ini
